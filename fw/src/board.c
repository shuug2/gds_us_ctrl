 ...
 * PB14/OSC4<-PC7. PB12(OSC2? 미확정)만 미설정 — PB13은 io.c가 OVLD sense 입력으로
 * 설정함(OSC 아님, 건드리지 말 것). 실제 발진 구동은 B-SEAM(stub) — 여기선 idle만.
 * (heartbeat PB3는 dormant → io.c가 OVLD 릴레이로 재용도, 2026-06-20 제거) */
